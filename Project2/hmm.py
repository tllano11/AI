class HMM:
  ...
  """
    ...
    @property                                                   #@property is a build in python function that makes posible to create readonly properties
    def num_states(self):                                       #Calculate and return the states matrix
        return self._transition_probs.shape[0]

    @property
    def transition_probabilities(self):                         #Calculate and return the states matrix
